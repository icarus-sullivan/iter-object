...
test('iter_obj', () => {
  ...
  expect(fn.mock.calls[3]).toEqual(['zip', MOCK_OBJECT.src.foo.baz.zip]);
  expect(fn.mock.calls[4]).toEqual(['versions', MOCK_OBJECT.versions]);
  expect(fn.mock.calls[5]).toEqual(['0', MOCK_OBJECT.versions[0]]);
